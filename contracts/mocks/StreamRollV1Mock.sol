...
///@author StreamRoll
contract StreamRollV1Mock is ReentrancyGuard, Initializable {
    ...
    function _createFlow() external {
        // 10000 a month
        uint secondsPerDay = 86400;
        uint totalSeconds = secondsPerDay * 30; 
        uint _flowRate = (1000 * 1e18) / totalSeconds;
        console.log("flowRate -->", _flowRate);
